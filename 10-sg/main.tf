module "frontend" {
  ...
  source = "git::https://github.com/Eswar1233/terraform-aws-security-group.git?ref=main"
  project = var.project
...
resource "aws_security_group_rule" "mongodb_app_from_bastion" {
  type              = "ingress"
  from_port         = 27017
  to_port           = 27017
  protocol          = "tcp"
