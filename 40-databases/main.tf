...
resource "terraform_data" "mongodb" {
  ...
  # to copy file we need connection so after we copy file /tmp/mongodb.sh. we execute this using remote-exec.so run chesaka it will go to mongodb,sh and install ansible. 
  connection {
    type     = "ssh"
    user     = "ec2-user"
    password = "DevOps321"
